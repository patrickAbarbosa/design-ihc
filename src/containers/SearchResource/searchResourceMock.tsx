...
const renderViewResource = () => (
  <AppButton variant="link-default" h="20px">
    Ver reservas
  </AppButton>
);
...
const lines: AppTableBodyProps["lines"] = [
  [
    { children: "Quadra de basquete" },
    { children: 1 },
    { children: "Sim" },
    { children: renderViewResource() },
  ],
  [
    { children: "Bola de handebol" },
    { children: 48 },
    { children: "Não" },
    { children: renderViewResource() },
  ],
  [
    { children: "Bola de voleibol" },
    { children: 64 },
    { children: "Sim" },
    { children: renderViewResource() },
  ],
